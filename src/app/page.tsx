...
function CardOfTheDay() {
  const [card, setCard] = useState(majorArcana[0]);
  useEffect(() => {
    const dayIndex = new Date().getDate() % majorArcana.length;
    setCard(majorArcana[dayIndex]);
  }, []);
...
export default function HomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      {/* 오늘의 카드 */}
      <section className="mb-16"><CardOfTheDay /></section>
